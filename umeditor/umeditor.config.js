...
(function () {
     ...
     */
    if (window.location.href.indexOf("/user/active/pro") != -1) {
        var topOffsetVal = 48;
    } else if (window.location.href.indexOf("/user/active/edit") != -1 || window.location.href.indexOf("/user/active/addActive") != -1) {
        var topOffsetVal = 48;
    } else {
        var topOffsetVal = 0;
    }
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,toolbar:[
            ...
            '| horizontal ',//print '
            'preview fullscreen', 'drafts', 'formula'
        ]
